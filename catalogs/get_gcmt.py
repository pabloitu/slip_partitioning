...
cat = c_fdsn.get_events(minlatitude = minlat, maxlatitude = maxlat, minlongitude = minlon, maxlongitude = maxlon,
                        minmagnitude=minmag, maxmagnitude=maxmag, starttime = starttime, endtime = endtime,
...
filename = 'global_2/CMTSOLUTIONS_2005-2025'
...
print ('\n', end = '\n')
print ('The CMT catalog is ready, it is stored in the `CMTSOLUTIONS_2005-2025` file')