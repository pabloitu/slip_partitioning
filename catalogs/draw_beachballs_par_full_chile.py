...
# ---------- CONFIG ----------
INPUT_CSV   = "gem_labeled.csv"
OUT_DIR     = "beachballs_fullchile_svg2"  # folder will be created
...
CLASS_COLORS = {
    "crustal_intraarc_shallow": "orange",
    "crustal_intraarc_deep":    "orange",
    "subduction_interface":     "teal",
    "subduction_intraslab":     "teal",
    "deep_subduction":          "firebrick",
...
def draw_one_png(out_path: str, facecolor: str, mt=None, sdr=None, width_pt=220):
    ...
    fig.savefig(out_path, format="svg", dpi=30,
...
def _render_worker(row_dict):
    ...
    try:
        ...
        out_path = os.path.join(OUT_DIR, f"{eid}.svg")
